...
export const translations: Translations = {
  ...
  // Hero Section
  "hero.badge": { ar: "منصة التجارة الإلكترونية رقم ١", en: "#1 E-commerce Platform" },
  "hero.title1": { ar: "أنشئ متجرك", en: "Build Your" },
  "hero.title2": { ar: "الإلكتروني", en: "Online Store" },
  "hero.title3": { ar: "بكل سهولة", en: "Effortlessly" },
  "hero.description": { 
    ar: "أطلق متجرك الإلكتروني في دقائق مع نطاقك الخاص، لوحة تحكم متكاملة، ونظام دفع آمن. كل ما تحتاجه لتبدأ البيع اليوم.",
    en: "Launch your online store in minutes with your custom domain, powerful dashboard, and secure payments. Everything you need to start selling today."
  },
  "hero.startFree": { ar: "ابدأ مجاناً", en: "Start Free" },
  "hero.watchDemo": { ar: "شاهد العرض", en: "Watch Demo" },
  "hero.trustedBy": { ar: "موثوق من قبل أكثر من", en: "Trusted by" },
  "hero.merchants": { ar: "تاجر", en: "merchants" },
  "hero.noCard": { ar: "لا حاجة لبطاقة ائتمان", en: "No credit card required" },
  
  // Features Section
  "features.badge": { ar: "كل ما تحتاجه", en: "Everything You Need" },
  "features.title": { ar: "أدوات قوية لنجاح متجرك", en: "Powerful Tools for Your Success" },
  ...
  "features.customDomain.desc": { ar: "احصل على متجرك بنطاقك الخاص مثل yourstore.com", en: "Get your store with your own domain like yourstore.com" },
  
  "features.dashboard.title": { ar: "لوحة تحكم متقدمة", en: "Advanced Dashboard" },
  "features.dashboard.desc": { ar: "تحكم كامل بمنتجاتك، طلباتك، وعملائك من مكان واحد", en: "Full control over products, orders, and customers from one place" },
  
  "features.payments.title": { ar: "دفع آمن", en: "Secure Payments" },
  "features.payments.desc": { ar: "دعم لجميع وسائل الدفع المحلية والعالمية", en: "Support for all local and international payment methods" },
  
  "features.analytics.title": { ar: "تحليلات متقدمة", en: "Advanced Analytics" },
  "features.analytics.desc": { ar: "تقارير مفصلة عن المبيعات والزوار والأداء", en: "Detailed reports on sales, visitors, and performance" },
  
  "features.mobile.title": { ar: "متوافق مع الجوال", en: "Mobile Optimized" },
  "features.mobile.desc": { ar: "متجرك يعمل بشكل مثالي على جميع الأجهزة", en: "Your store works perfectly on all devices" },
  
  "features.support.title": { ar: "دعم ٢٤/٧", en: "24/7 Support" },
  "features.support.desc": { ar: "فريق دعم متخصص جاهز لمساعدتك على مدار الساعة", en: "Dedicated support team ready to help around the clock" },
  
  // How It Works
  "howItWorks.badge": { ar: "كيف يعمل", en: "How It Works" },
  "howItWorks.title": { ar: "أطلق متجرك في ٣ خطوات", en: "Launch Your Store in 3 Steps" },
  "howItWorks.step1.title": { ar: "سجّل حسابك", en: "Create Account" },
  "howItWorks.step1.desc": { ar: "أنشئ حسابك مجاناً في أقل من دقيقة", en: "Sign up for free in less than a minute" },
  "howItWorks.step2.title": { ar: "خصص متجرك", en: "Customize Store" },
  "howItWorks.step2.desc": { ar: "اختر قالبك وأضف منتجاتك بسهولة", en: "Choose your template and add products easily" },
  "howItWorks.step3.title": { ar: "ابدأ البيع", en: "Start Selling" },
  "howItWorks.step3.desc": { ar: "أطلق متجرك واستقبل أول طلباتك", en: "Launch your store and receive your first orders" },
  
  // Pricing
  "pricing.badge": { ar: "أسعار مناسبة", en: "Simple Pricing" },
  "pricing.title": { ar: "اختر الخطة المناسبة لك", en: "Choose Your Plan" },
  "pricing.description": { ar: "أسعار شفافة بدون رسوم خفية", en: "Transparent pricing with no hidden fees" },
  ...
  "pricing.enterprise.desc": { ar: "للأعمال الكبيرة", en: "For large businesses" },
  "pricing.enterprise.f1": { ar: "كل مميزات الاحترافي", en: "All Pro features" },
  "pricing.enterprise.f2": { ar: "مدير حساب مخصص", en: "Dedicated account manager" },
  ...
  "cta.description": { ar: "انضم لآلاف التجار الناجحين وابدأ البيع اليوم", en: "Join thousands of successful merchants and start selling today" },
  "cta.button": { ar: "ابدأ مجاناً الآن", en: "Start Free Now" },
  
  // Footer
  "footer.description": { ar: "منصتك الشاملة لإنشاء وإدارة متجرك الإلكتروني بكل سهولة", en: "Your complete platform to create and manage your online store with ease" },
